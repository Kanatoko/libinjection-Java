...
public class SqlParse {
    ...
    public static final int SQLI_MAX_TOKENS = 5;
...
for( int i = 0; i < 26; ++i )
    ...
    public static List tokenize(String input, List valueList, String[] allTokenBuf, int flags, final boolean withFolding) {
        ...
        while (inputLength > totalProcessedLength) {
            ...
            //fold
            if (withFolding && token.length() >= SQLI_MAX_TOKENS) {
                final String foldedToken = fold(valueList, token.toString());
                folded = true;
                if (foldedToken.length() >= SQLI_MAX_TOKENS) {
    ...
    public static String fold(List valueList, final String token) {
        ...
        if (lastToken.length() > SQLI_MAX_TOKENS) {
            lastToken = lastToken.substring(0, SQLI_MAX_TOKENS);
        }
    ...
    public static String foldImpl(List valueList, String token) {
        ...
        StringBuilder foldedTokenBuf = new StringBuilder();
        loop:
        ...
        if (foldedValueList.size() >= SQLI_MAX_TOKENS) {
            ...
            if ((foldedToken.startsWith("1o(1)") || foldedToken.startsWith("1,(1)"))
                ...
                foldedTokenBuf = new StringBuilder();
